...
- Optional OSINT identity adapters (Holehe, PhoneInfoga, Mosint, h8mail) are free CLI wrappers only. Missing binaries soft-fail. Do not add paid Hunter/HIBP/DeHashed/IntelX/Epieos keys. Never persist breach passwords; redact credential pairs before notes or evidence. OSINT must not contact claimants.
